(function() {
    ...
    Lampa.Storage.set('online_mod_save_last_balanser', 'false');
    Lampa.Storage.set('online_mod_rezka2_fix_stream', 'true');
    Lampa.Storage.set('online_mod_rezka2_status', 'true');
    Lampa.Storage.set('online_mod_rezka2_name', 'alexroozvelt@ya.ru');
    Lampa.Storage.set('online_mod_rezka2_password', '8524646r');
