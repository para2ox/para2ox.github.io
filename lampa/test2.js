...
/* ЗАКОММЕНТИРОВАНО ДЛЯ ИСКЛЮЧЕНИЯ ОШИБКИ 500 НА ANDROID TV */
...
.card__type, .card__quality {
    z-index: 2;
        ...
        // --- ЧАСТЬ 4: ФИКС ANDROID TV ---
        // Блокируем surs.js, если он пытается закрыть уже открытый фильм на старте
