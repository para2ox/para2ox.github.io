(function () {
    ...
    try {
        // =======================================================
        // 1. УБИРАЕМ МИГАНИЕ (Мгновенная загрузка surs.js и стилей)
        // =======================================================
        
        // Сразу грузим главную страницу, не дожидаясь отрисовки Lampa!
        ...
        function startPlugin() {
            // Оставшиеся плагины грузим в фоне через ядро Lampa
