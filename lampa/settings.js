(function () {
    ...
    try {
        ...
        function injectCSS() {
            ...
            // Карточки
            css += '.selector:not(.menu__item, .card, .show, .full-person, .full-start-new__reactions) { border-radius: 1em; } ';
            css += '.selector:not(.menu__item, .card, .show, .full-person, .full-start-new__reactions) * { filter: none !important; } ';
            css += '.selector:not(.menu__item, .card, .show, .full-person, .full-start-new__reactions)::before { backdrop-filter: blur(12px) !important; -webkit-backdrop-filter: blur(12px) !important; } ';
            css += '.card .card__view::before, .card-episode .full-episode::before, .register::before, .selector:not(.menu__item, .card, .show, .full-person, .full-start-new__reactions)::before { content: ""; position: absolute; inset: 0; border: 0 !important; border-radius: 1em; pointer-events: none; opacity: 0; transition: opacity 0.6s cubic-bezier(0.16, 1, 0.3, 1) !important; will-change: opacity; z-index: 2; box-shadow: inset 2px 2px 1px rgba(255, 255, 255, 0.30), inset -2px -2px 2px rgba(255, 255, 255, 0.30); background: radial-gradient(ellipse 130% 100% at 15% 10%, rgba(255, 255, 255, 0.35) 0%, rgba(255, 255, 255, 0.10) 40%, transparent 65%), linear-gradient(135deg, rgba(255, 255, 255, 0.22) 0%, transparent 25%, transparent 75%, rgba(255, 255, 255, 0.38) 100%); mix-blend-mode: screen; } ';
            css += '.card .card__view::after, .card-episode .full-episode::after, .register::after, .selector:not(.menu__item, .card, .show, .full-person, .full-start-new__reactions)::after { display: none; } ';
            css += '.card.focus .card__view::before, .card.hover .card__view::before, .card-episode.focus .full-episode::before, .register.focus::before, .selector:not(.menu__item, .card, .show, .full-person, .full-start-new__reactions).focus::before { opacity: 1; } ';
            css += '.card.focus, .card-episode.focus, .register.focus { transform: scale(1.08) translateY(-6px) !important; z-index: 10; } ';
            css += '.selector:not(.menu__item, .card, .show, .full-person, .full-start-new__reactions).focus { transform: scale(1.00) !important; z-index: 10; box-shadow: none !important; } ';
            css += '.card, .card-episode, .register, .selector:not(.menu__item, .card, .show, .full-person, .full-start-new__reactions) { transition: transform 0.6s cubic-bezier(0.16, 1, 0.3, 1) !important; will-change: transform; -webkit-animation: none !important; animation: none !important; } ';
            css += '.card.focus .card__view, .card.hover .card__view, .card-episode.focus .full-episode, .register.focus, .selector:not(.menu__item, .card, .show, .full-person, .full-start-new__reactions).focus { position: relative !important; border-radius: 1em !important; background: rgba(255, 255, 255, 0.05) !important; color: #fff !important; flex-shrink: 0 !important; transition: box-shadow 0.6s cubic-bezier(0.16, 1, 0.3, 1), backdrop-filter 0.6s cubic-bezier(0.16, 1, 0.3, 1), -webkit-backdrop-filter 0.6s cubic-bezier(0.16, 1, 0.3, 1), transform 0.6s cubic-bezier(0.16, 1, 0.3, 1), background 0.6s cubic-bezier(0.16, 1, 0.3, 1) !important; will-change: transform, box-shadow, backdrop-filter; -webkit-animation: none !important; animation: none !important; overflow: hidden; } ';
