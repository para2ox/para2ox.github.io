(function () {
    ...
    try {
        ...
        function injectCSS() {
            ...
            css += '.full-review-add { display: none; } ';
            ...
            css += '.selector:not(.menu__item, .card, .show, .full-review-add, .full-person, .full-start-new__reactions).focus { transform: scale(1.00) !important; z-index: 10; box-shadow: none !important; } ';
            css += '.card, .card-episode, .register, .selector:not(.menu__item, .card, .show, .full-review-add, .full-person, .full-start-new__reactions) { transition: transform 0.6s cubic-bezier(0.16, 1, 0.3, 1) !important; will-change: transform; -webkit-animation: none !important; animation: none !important; } ';
            css += '.card.focus .card__view, .card.hover .card__view, .card-episode.focus .full-episode, .register.focus, .selector:not(.menu__item, .card, .show, .full-review-add, .full-person, .full-start-new__reactions).focus { position: relative !important; border-radius: 1em !important; background: rgba(255, 255, 255, 0.05) !important; color: #fff !important; flex-shrink: 0 !important; transition: box-shadow 0.6s cubic-bezier(0.16, 1, 0.3, 1), backdrop-filter 0.6s cubic-bezier(0.16, 1, 0.3, 1), -webkit-backdrop-filter 0.6s cubic-bezier(0.16, 1, 0.3, 1), transform 0.6s cubic-bezier(0.16, 1, 0.3, 1), background 0.6s cubic-bezier(0.16, 1, 0.3, 1) !important; will-change: transform, box-shadow, backdrop-filter; -webkit-animation: none !important; animation: none !important; overflow: hidden; } ';
            css += '.card .card__view, .card-episode .full-episode, .register, .selector:not(.menu__item, .card, .show, .full-review-add, .full-person, .full-start-new__reactions) { animation: none !important; margin-bottom: 1em; } ';
