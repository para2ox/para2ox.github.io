(function () {
    ...
    try {
        ...
        function injectCSS() {
            ...
            css += '.selector:not(.menu__item, .card, .show, .full-review-add, .full-person, .full-start-new__reactions).focus { transform: scale(1.01) !important; z-index: 10; box-shadow: none !important; } ';
